...
function makeStatement($data) {
	...
	switch($t) {
		...
		case "locations_by_user_id" : return makeQuery($c,"SELECT l.* FROM `track_resources` a LEFT JOIN `track_locations` l ON a.id = l.resource_id WHERE a.user_id=? ORDER BY l.date_create DESC",$p);
		...
		// DELETE STATEMENTS
		case "delete_animal":
			return makeQuery($c,"DELETE FROM `track_resources` WHERE `id`=?",$p,false);
