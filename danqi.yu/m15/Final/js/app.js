...
$(()=>{
	...
	.on("change","#settings-animal-profile-photo-upload",function(e){
		console.log(e)
		checkUpload(this.files[0])
		.then(d=>{
			console.log(d)
			$("#settings-animal-profile-photo").val('uploads/'+d.result);
			$("#settings-animal-profile-form .imagepicker")
      		.addClass("picked")
      		.css({'background-image':`url('uploads/${d.result}')`})
		})
	})
	...
	.on("change","#add-animal-photo-upload",function(e){
		console.log(e)
		checkUpload(this.files[0])
		.then(d=>{
			console.log(d)
			$("#add-animal-photo").val('uploads/'+d.result);
			$("#add-animal-form .imagepicker")
      		.addClass("picked")
      		.css({'background-image':`url('uploads/${d.result}')`})
		})
	})
	...
	.on("click",".js-submit-settings-password",function(e){
		e.preventDefault();
		checkSettingsProfilePasswordPage();
	})
